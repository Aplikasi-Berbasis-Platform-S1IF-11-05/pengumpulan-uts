    ...
    <div class="col-md-9">
        <div class="card shadow-sm">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.skill.create') }}" class="btn btn-dark btn-sm"> Tambah Skill</a>
            </div>
            <div class="card-body">
                @if (count($skills) > 0)
                            ...
                            <tbody>
                                @foreach ($skills as $skill)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('admin.skill.edit', $skill) }}" class="btn btn-outline-dark btn-sm me-1">Edit</a>
                                            <form method="POST" action="{{ route('admin.skill.destroy', $skill) }}" class="d-inline">
                                                @csrf
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <a href="{{ route('admin.skill.create') }}" class="btn btn-dark">Tambah Sekarang</a>
                    </div>
                @endif
            </div>
        </div>
